...
class Boss(object):
    ...
    def __init__(self, state_dim, goal_dim, G_init, policy, reachability_algorithm, t_re, t_unre, goal_cond=True, mem_capacity=1e5):
        self.G = G_init
    ...
    def split(self, forward_model, start_partition, target_partition, replay_buffer=[]):
        ...
        if self.reachability_algorithm == "Ai2":
            ...
            partitions = reach_analysis.reachability_analysis("./nnet/forward_" + str(start_partition) + "_" + str(
                target_partition) + ".nnet", input, [self.G[target_partition]], "Ai2", self.t_re, self.t_unre)
